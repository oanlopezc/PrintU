...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>\n      Iniciar Sesión\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-card>\n  <img class=\"icon\" src=\"assets/icon/imagen_printU.jpeg\" alt=\"\"> \n  <form #form=\"ngForm\" (ngSubmit)=\"login(form)\" method=\"post\">\n  <ion-item>\n    <ion-label position=\"floating\">Email(UN)</ion-label>\n    <ion-input type=\"email\" name=\"email_i\" inputmode=\"email\" clear-input=\"true\" value=\"@unal.edu.co\"></ion-input>\n    </ion-item>\n    <ion-item>\n    <ion-label position=\"floating\">Contraseña</ion-label>\n    <ion-input type=\"password\" name=\"password_i\" inputmode=\"password\" clear-input=\"true\" minlength=\"8\" maxlength=\"16\"></ion-input>\n    </ion-item>\n    <ion-button color=\"secondary\" expand=\"block\" size=\"small\">Recordar Contraseña</ion-button>\n    <br>\n    <ion-button type=\"submit\" expand=\"block\" size=\"large\" (Click)=\"login()\">Entrar</ion-button>\n  </form> \n<p text-center>¿Aún no tienes cuenta?</p>\n<ion-button expand=\"block\" color=\"secondary\">Regístrate</ion-button>\n</ion-card>\n</ion-content>\n"
...
module.exports = ".icon {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n  width: 50%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(modalController, authService, navCtrl) {
        this.modalController = modalController;
        this.authService = authService;
        this.navCtrl = navCtrl;
    }
    ...
    RegisterPage.prototype.registro = function (form) {
        console.log(form.value);
        this.newRegister(form.value.name, form.value.apellido, form.value.email, form.value.password, form.value.NFC_id);
    };
    RegisterPage.prototype.newRegister = function (name, apellido, email, password, NFC_id) {
...
var AuthService = /** @class */ (function () {
    function AuthService(http, env) {
        ...
        this.API_URL = 'http://127.0.0.1:1880/';
    }
    AuthService.prototype.holi = function (mensaje) {
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _env_service__WEBPACK_IMPORTED_MODULE_3__["EnvService"]])
    ], AuthService);
    return AuthService;
}());
