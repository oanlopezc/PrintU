...
var routes = [
    ...
    { path: 'medio', loadChildren: './medio/medio.module#MedioPageModule' },
    { path: 'ubicacion', loadChildren: './ubicacion/ubicacion.module#UbicacionPageModule' },
    { path: 'newdoc', loadChildren: './newdoc/newdoc.module#NewdocPageModule' },
    { path: 'mydoc', loadChildren: './mydoc/mydoc.module#MydocPageModule' }
];
