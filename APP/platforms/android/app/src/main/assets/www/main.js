...
var map = {
	...
	"./pages/comousar/comousar.module": [
	...
	"./pages/medio/medio.module": [
		"./src/app/pages/medio/medio.module.ts",
		"pages-medio-medio-module"
	],
	"./pages/mydoc/mydoc.module": [
		"./src/app/pages/mydoc/mydoc.module.ts",
		"pages-mydoc-mydoc-module"
	],
	"./pages/newdoc/newdoc.module": [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, taskService) {
        ...
        this.title = 'angular-http-client';
        this.initializeApp();
    }
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_13__["GoogleMaps"],
...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.getAllTasks = function () {
        var path = "http://127.0.0.1:1880/Users";
        return this.http.get(path);
    };
    TaskService.prototype.getuno = function (email) {
        var path = 'http://127.0.0.1:1880/myn?email=' + email;
        return this.http.get(path);
    };
    ...
    TaskService.prototype.getUs = function (id) {
    ...
    TaskService.prototype.updateTask = function (task) {
        var path = 'http://127.0.0.1:1880' + "/register?id=" + task.id + "&NFC_id=" + task.NFC_id + "&nombre=" + task.nombre + "&apellido=" + task.apellido + "&email=" + task.email + "&password=" + task.password;
...
module.exports = __webpack_require__(/*! /home/nicolas_garcia_r/proyects_ionic/imp_2/src/main.ts */"./src/main.ts");
